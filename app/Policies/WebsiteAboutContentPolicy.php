 ...
 */
class WebsiteAboutContentPolicy
{
    ...
    public function view(User $user, WebsiteAboutContent $content): bool
    {
    ...
    public function update(User $user, WebsiteAboutContent $content): bool
    {
        $membership = $this->membershipFor($user);
