 ...
 */
class WebsiteContactContentPolicy
{
    ...
    public function view(User $user, WebsiteContactContent $content): bool
    {
    ...
    public function update(User $user, WebsiteContactContent $content): bool
    {
        $membership = $this->membershipFor($user);
