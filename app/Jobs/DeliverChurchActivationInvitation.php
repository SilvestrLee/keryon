...
final class DeliverChurchActivationInvitation implements ShouldBeEncrypted, ShouldQueue
{
    ...
    {
        $delivery->execute($this->attemptUuid, InvitationDeliverySubjectType::CHURCH_ACTIVATION);
    }
}
